...
<html lang="en">
    <head>                        
        <title>Government Yojana User | My Applications</title>            
...
$query = mysqli_query($con,"SELECT a.*, y.yojana_requirement FROM applied_yojana a JOIN yojana y ON a.yojana_name = y.yojana_name WHERE a.email = '$userEmail' ORDER BY a.yojana_id DESC") or die(mysqli_error($con));
$counter=0;
...
?>
                                        <tr>
                                            ...
                                            <td>
                                                <?php 
                                                if($row['yojana_status'] == 'pending') {
                                                    echo '<span class="label label-warning">Pending</span>';
                                                } else if($row['yojana_status'] == 'approved') {
                                                    echo '<span class="label label-primary">Approved</span>';
                                                } else if($row['yojana_status'] == 'succeed') {
