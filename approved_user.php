...
<html lang="en">
    <head>                        
        <title>Government Yojana Admin | View Approved User</title>            
                ...
                <div class="app-content app-sidebar-left">
                    ...
                    <div class="app-heading-container app-heading-bordered bottom">
                        <ul class="breadcrumb">
                            ...
                            <li class="active">View Approved User</li>
                        </ul>
                    </div>
                    <!-- END PAGE HEADING -->
...
$query="select * from user where user_status = 'approved' ORDER BY user_id DESC";
...
?>
                                        <tr>
                                            ...
                                            <td align="center">
                    <a class="green" href="disapprove_user.php?user_id=<?php echo $user_id; ?>" title="Disapprove User">
                        <i class="ace-icon fa fa-times bigger-130 text-danger"></i>
                    </a>
                    &nbsp;
