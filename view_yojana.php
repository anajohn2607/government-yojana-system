...
<html lang="en">
    <head>                        
        <title>Government Yojana Admin | View Yojana</title>            
                ...
                <div class="app-content app-sidebar-left">
                    ...
                    <div class="app-heading-container app-heading-bordered bottom">
                        <ul class="breadcrumb">
                            ...
                            <li class="active">View Yojana</li>
                        </ul>
                    </div>
                    <!-- END PAGE HEADING -->
                                ...
                                <table class="table table-striped table-bordered datatable-extended" id="sortable-data">
                                    <thead>
                                        <tr>
                                            <th>Sr. No.</th>
                                            <th>Yojana Name</th>
                                            <th>Yojana Description</th>
                                            <th>Yojana Image</th>
                                            <th>Yojana Requirement</th>
...
$query="select * from yojana ORDER BY id DESC";
...
?>
                                        <tr>
                                            ...
                                            <td><?php echo $row['yojana_description']; ?></td>
                                            <td>
                                   <img src="Yojana/<?php echo $row['yojana_image'];?>" height="50" width="90" alt="Yojana Image">
                                            </td>
                                             <td><?php echo $row['yojana_requirement'];?></td>
                                            <td align="center">
                    <a class="green" href="update_yojana.php?id=<?php echo $id; ?>" title="Edit Yojana">
                        <i class="ace-icon fa fa-edit bigger-130"></i>
                    </a>
                    &nbsp;
                    <a class="red" onClick="return confirm('Are You Sure You Want To Delete This Yojana ?');"  href="delete_standard.php?id=<?php echo $id; ?>" title="Delete Yojana">
