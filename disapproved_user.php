...
<html lang="en">
    <head>                        
        <title>Government Yojana Admin | View Disapproved User</title>            
    ...
    <?php  include "menu_bar.php"; ?>
                ...
                <div class="app-content app-sidebar-left">
                    ...
                    <div class="app-heading-container app-heading-bordered bottom">
                        <ul class="breadcrumb">
                            <li><a href="#">Disapproved User</a></li>                                                     
                            <li class="active">View Disapproved User</li>
                        </ul>
                    </div>
                    <!-- END PAGE HEADING -->
...
$query="select * from user where user_status = 'disapproved' ORDER BY user_id DESC";
