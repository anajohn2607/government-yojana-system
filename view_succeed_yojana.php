...
<html lang="en">
    <head>                        
        <title>Government Yojana User | View Succeed Yojana</title>            
    ...
    <?php  include "menu_bar.php"; ?>
                ...
                <div class="app-content app-sidebar-left">
                    ...
                    <div class="app-heading-container app-heading-bordered bottom">
                        <ul class="breadcrumb">
                            <li><a href="#">Succeed Yojana</a></li>                                                     
                            <li class="active">View Succeed Yojana</li>
                        </ul>
                    </div>
                    <!-- END PAGE HEADING -->
...
$query = mysqli_query($con,"SELECT a.*, y.yojana_requirement FROM applied_yojana a JOIN yojana y ON a.yojana_name = y.yojana_name WHERE a.yojana_status = 'succeed' AND a.email = '$userEmail' ORDER BY a.yojana_id DESC") or die(mysqli_error($con));
$counter=0;
...
?>
                                        <tr>
                                            ...
                                            <td>
                                                <div class="alert alert-success margin-bottom-0" style="padding: 5px 10px;">
                                                    <i class="fa fa-check-circle"></i> <strong>Congratulations!</strong> Your application for this yojana has been successfully completed.
                                                </div>
                                            </td>
                                        </tr>
<?php
